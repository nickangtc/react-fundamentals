...
A react Fragment isn't just an unlablled wrapper - it is actually a non-existing element in the DOM! Fragments make it possible for two React elements to be rendered side by side with no contrived wrapping element.
